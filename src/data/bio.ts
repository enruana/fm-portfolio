...
export const skills: Skill[] = [
  ...
  { name: "LangGraph", level: "Advanced", category: "Backend" },
  { name: "LangChain", level: "Advanced", category: "Backend" },
  { name: "Docker", level: "Advanced", category: "Tools" },
  { name: "AWS", level: "Advanced", category: "Tools" },
  { name: "Azure", level: "Intermediate", category: "Tools" },
  { name: "GCP", level: "Advanced", category: "Tools" },
  ...
  { name: "PostgreSQL", level: "Advanced", category: "Tools" },
  { name: "MongoDB", level: "Advanced", category: "Tools" },
  { name: "Redis", level: "Advanced", category: "Tools" },
  { name: "SQL", level: "Advanced", category: "Tools" },
  ...
  { name: "Emotional Intelligence", level: "Advanced", category: "Other" },
